 ...
 */
public class ChangeSettingsDialogActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daiolog_change_settings);
        mLayout = (LinearLayout) findViewById(R.id.settings_dialog);
