...
public class Vote {
    ...
    public Vote(String assemblyman_id, Integer update_tag, String bill_name, Integer bill_no, String vote_dttm, String mod_dttm, String bill_target_url, String result, String assemblyman_vote) {
